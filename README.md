...
```bash
mkdir -p .github
curl -o .github/copilot-instructions.md https://raw.githubusercontent.com/forrestchang/andrej-karpathy-skills/main/agents/vscode-copilot/COPILOT.md
```
...
```bash
# Codex
curl -o CODEX.md https://raw.githubusercontent.com/forrestchang/andrej-karpathy-skills/main/agents/codex/CODEX.md

# OpenClaw
curl -o OPENCLAW.md https://raw.githubusercontent.com/forrestchang/andrej-karpathy-skills/main/agents/openclaw/OPENCLAW.md

# Gemini CLI
curl -o GEMINI.md https://raw.githubusercontent.com/forrestchang/andrej-karpathy-skills/main/agents/gemini-cli/GEMINI.md
```
