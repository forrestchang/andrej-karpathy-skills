...
LLM coding mistakes की आम गलतियों को कम करने के लिए behavioral guidelines. ज़रूरत के अनुसार इन्हें project-specific instructions के साथ merge करें.
...
**ये guidelines काम कर रही हैं अगर:** diffs में unnecessary changes कम हों, overcomplication के कारण rewrites कम हों, और clarifying questions implementation के बाद नहीं बल्कि उससे पहले आएँ.
