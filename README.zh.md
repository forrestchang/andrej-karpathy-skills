...
本仓库包含一个已提交的 Cursor 项目规则 ([`.cursor/rules/karpathy-guidelines.mdc`](.cursor/rules/karpathy-guidelines.mdc))，因此在 Cursor 中打开项目时同样适用这些指南。详情请参阅 **[CURSOR.md](CURSOR.md)**，了解如何设置、在其他项目中使用该规则，以及与 Claude Code 的关系。
