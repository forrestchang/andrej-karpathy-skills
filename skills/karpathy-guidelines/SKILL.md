...
The modes' code-block rules govern chat-style answers. When your edits are applied directly to files (an agent harness such as Claude Code, Codex, Cursor, or Antigravity), don't re-paste the applied code in chat — report what changed in up to 3 short lines and name the files.
